    ...
    <x-app-layout>
        <nav>
            <div class="p-2 sm:ml-64">
                <div class="border-gray-200 rounded-lg dark:border-gray-700 mt-[4.5rem]">
                    <div id='recipients' class="py-8 px-4 mt-6 lg:mt-0 rounded shadow bg-white font-sans">
                        <h2 class="w-full flex justify-center items-center font-extrabold">
                            <span class=" hidden sm:block bg-gradient-to-r from-blue-500 to-blue-600 text-transparent bg-clip-text text-center leading-normal md:text-4xl text-2xl"> GOBIERNO REGIONAL PUNO</span>    
                        </h2>
                       
    
                        <div class="p-4 mt-6  grid grid-cols-12 gap-6">
            ...
            <div class=" hidden sm:block sm:ml-64">
                <div class="px-2 grid grid-cols-12 gap-6">
                                    ...
                                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96 ">
                                        ...
                                        <div class="hidden duration-700 ease-in-out " data-carousel-item>
                                            <!-- <div class="flex flex-col justify-center items-center gap-5"> -->
                                                ...
                                                <img src="/img/carrusel1.jpg" class="absolute block object-contain w-full h-full top-0 left-0" alt="...">
                                            <!-- </div> -->
                                        </div>
                                        <!-- Item 2 -->
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="/img/carrusel2.jpg" class="absolute block object-contain w-full h-full top-0 left-0" alt="...">
                                        </div>
                                        <!-- Item 3 -->
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="/img/carrusel3.jpg" class="absolute block object-contain w-full h-full top-0 left-0" alt="...">
                                        </div>
                                        <!-- Item 4 -->
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="/img/carrusel2.jpg" class="absolute block object-contain w-full h-full top-0 left-0" alt="...">
