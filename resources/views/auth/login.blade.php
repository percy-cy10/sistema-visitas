<x-guest-layout>
    <div class="w-full min-h-screen flex justify-center items-center gap-20  px-4 sm:px-0">
        ...
        <div class="flex flex-col gap-7 bg-white p-14 shadow-lg rounded-xl relative">
            ...
            <div class="w-full ">
                <h2 class="text-2xl font-semibold uppercase">Gobierno Regional Puno</h2>
            </div>
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <button type="submit" class=" uppercase w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
